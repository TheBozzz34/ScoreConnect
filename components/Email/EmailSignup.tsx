      ...
      <div className="flex w-full flex-col items-center">
        ...
        <div className="flex w-full flex-row justify-center">
          <input
            ...
            name="firstName"
            placeholder="Jon"
            className="mb-2 mr-4 w-1/6 rounded-md bg-[#dcd8c0] p-2 text-[#454138] placeholder-[#454138] focus:border-transparent focus:outline-none focus:ring-2 focus:ring-[#bab5a1]"
            required

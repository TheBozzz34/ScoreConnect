...
import { title, subtitle } from '../components/primatives';
        ...
        <div className='text-white'>
            ...
            <section className="flex flex-col items-center justify-left gap-4 py-8 md:py-10">
                <div className="max-w-lg text-left justify-left">
                    ...
                    <Snippet hideSymbol hideCopyButton variant="bordered" className="bg-transparent border border-white rounded-md px-4 py-2 select-none">
            ...
            <hr className="border-t-1 border-default-600 dark:border-default-100" />

            <section id="feature-cards" className="flex flex-col items-center justify-left gap-4 py-8 md:py-10">
                <div className="inline-block max-w-lg text-right justify-left">
                ...
                <div className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
                    <div className="flex flex-row items-center justify-center gap-4 py-8 md:py-10">
                        <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-7 transform hover:scale-105 transition duration-300 ease-in-out" radius='md'>
                            <Image
                                removeWrapper

      ...
      {isMobile ? (
        ...
        <div className="inline-flex h-full w-full items-center justify-center">
          ...
          <div className="w-[40%] rounded-lg p-4 shadow-md">
            <div className="mx-auto mt-8 w-[95%] rounded-lg bg-[#454138] p-4 shadow-md">
              <h2 className="border-b-[#dcd8c0] text-xl font-semibold text-[#dcd8c0]">About ScoreConnect</h2>
            </div>
            <div className="inline-flex">
              <div className="mx-auto mr-4 mt-8 w-[40%] rounded-lg bg-[#454138] p-4 shadow-md">
              ...
              <div className="mx-auto mt-8 w-[40%] rounded-lg bg-[#454138] p-4 shadow-md">
